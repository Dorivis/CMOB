...
public class GrpcServer extends grpcServiceGrpc.grpcServiceImplBase {
    ...
    @Override
    public void getMemories(Service.Empty request, StreamObserver<Service.memoriesResponse> responseObserver) {
    ...
    @Override
    public void getCodelets(Service.Empty request, StreamObserver<Service.codeletsResponse> responseObserver) {
    ...
    @Override
    public void getInfo(Service.indexInfo request, StreamObserver<Service.responseInfo> responseObserver) {
    ...
    @Override
    public void setInfo(Service.infoAdd request, StreamObserver<Service.responseOK> responseObserver){
